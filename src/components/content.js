  ...
  return (
    <div className='bg-slate-50 h-[100vh] font-san'>
      <Box bgcolor='#070429' position="fixed" width="100%" boxShadow="0 0 10px gray" zIndex={9999} className='p-2'>
        ...
        <h6 className='text-[1.2em]   text-gray-200  font-medium'>CLIENT DASHBOARD</h6>
      ...
      <div className='mt-[120px]'>
        <Stack direction={{ xs: 'column', sm: 'row' }} className='mr-3 ' gap="10px">
          ...
          <h6 className='text-[1.2em] text-center mb-3  bg-slate-300 p-3 text-gray-800  font-medium'>STRESS RELIEVE CONTENT</h6>
              ...
              <div className='flex gap-1'>
                 ...
                 <div className="h-full overflow-auto w-[100%]">
                    ...
                    <div className=" my-3 mx-3  overflow-auto  p-3 h-[72vh] border border-gray-200">
                           ...
                           {/* MESSAGES
                                ...
                                <Box className=' bg-white' height='72vh' display='grid' gridTemplateColumns='repeat(3, 1fr)' gap={5} p={3} m={1}>
                                        {/* Cards */}
                                        <div className='bg-gray-50 p-3 shadow-xl rounded-lg'>
                                      
                                           <video src={require('../play.mp4')} controls></video>
                                            {/* Description */}
                                            <p className='text-lg text-gray-800 font-semibold mb-2'>Description: Cartoon video</p> 
