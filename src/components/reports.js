...
import { Box, Stack, Button, Modal, IconButton, TextField, Skeleton } from '@mui/material'
...
function Reports() {
  ...
  return (
    ...
    <Footer/>
          ...
          <Box width={{ xs: '100%', sm: '85%' }} className="border border-slate-400 bg-white " height={{ sm: '75vh' }} >
                  ...
                  <div className=' flex gap-5'>
                    ...
                    <div className='flex gap-4 items-center'>
                          <p className='font-medium text-[1.4em]'>SYSTEM REPORTS</p>
                          <Button  variant='contained' onClick={generatePDF} > <Print/> EXPORT PDF </Button>
              ...
              <div className="  w-[6100%] shadow-2xl">
                    ...
                    <div className='mx-2 w-[40%] '>
                              ...
                              <div className=' w-[98%] mb-4 py-2 pb-1  border border-gray-400 bg-slate-100 p-3'>
                                      <div className='flex'>
                                        <PresentToAllOutlined style={{fontSize:'80px'}}/>
                                        <div>
                                        <h6 className='text-xl text-gray-800 font-extrabold '>TOTAL ITEMS FOUND</h6>
                                        <h6 className='text-sm text-gray-500 font-bold'>Items  found</h6>
                                        </div>
                                      </div>

                                      <hr className='border-[3px] border-gray-400'></hr>
                                      <div className='m-2 flex justify-center items-center shadow-xl p-2'>
                                      <h6 className='text-sm text-gray-800 text-center font-medium mt-2'> Total Found<br></br><span className='text-xl font-bold text-blue-600 font-serif'>{dataLength}</span></h6>
                              ...
                              <div className=' w-[98%] border pb-5 mt-1 border-gray-400 bg-slate-100 p-3'>
                                      <div className='flex'>
                                        <CompressRounded style={{fontSize:'80px'}}/>
                                        <div>
                                        <h6 className='text-xl text-gray-800 font-extrabold '>TOTAL ITEMS LOST</h6>
                                        <h6 className='text-sm text-gray-500 font-bold'>From all items lost </h6>
                                        </div>
                                      </div>
                                      <hr className='border-[3px] border-gray-400'></hr>

                                      <div className='m-2 flex justify-center items-center shadow-xl p-2'>
                                      <h6 className='text-sm text-gray-800 text-center font-medium mt-2'> Total Lost<br></br><span className='text-xl font-bold text-blue-600 font-serif'>{dataLength1}</span></h6>
      ...
      <h2 className='text-center font-medium'>Bar Graph Showing Items Lost and Found</h2>
      ...
      <div className='w-[600px] h-[45vh]'>
        ...
        >
          ...
          <Tooltip />
          <Legend />
          <Bar dataKey="TotalFound" fill="#8884d8" activeBar={<Rectangle fill="pink" stroke="blue" />} />
          <Bar dataKey="TotalLost" fill="#82ca9d" activeBar={<Rectangle fill="gold" stroke="purple" />} />
        </BarChart>
      </ResponsiveContainer>
      </div>
      ...
      <Modal open={successModalOpen} onClose={() => setSuccessModalOpen(false)}>
        <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', backgroundColor: 'white', padding: '100px' }}>
          <h2 className='text-[2em] font-extrabold text-green-600'>Feedback sent!</h2>
          <h2 className='text-[2em] font-extrabold text-green-600'>Thanks</h2>
