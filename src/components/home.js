          ...
          <Box width={{ xs: '100%', sm: '85%' }} className="border border-slate-400 bg-white" height={{ sm: '75vh' }} >
              ...
              <div className="h-full sm:overflow-auto w-[60%]">
                    ...
                    <div className="flex items-center gap-5 my-3 mx-3 justify-center bg-slate-100 p-3 h-[60vh] border border-gray-400">
                          ...
                          <h6 className='text-xl text-gray-800 font-extrabold mb-1 text-center '>UPLOAD A FOUND ITEM</h6>

                          <hr className='border-[3px] border-gray-400'></hr>
                          <TextField value={itemName} onChange={(e) => setItemName(e.target.value)} required multiline label="Item Name" sx={{backgroundColor:'white'}}></TextField>

                          <TextField value={description} onChange={(e) => setDescription(e.target.value)} required multiline label="Description" sx={{backgroundColor:'white'}}></TextField>
