...
function Found() {
  ...
  const handleClaim = async (itemName, description,contact) => {
      // Assume you have a server-side endpoint to handle inserting data into the collection
      try {
      ...
      <div className='mt-[100px]'>
       ...
       {/* Description */}
                 ...
                 <CardActions>
                  ...
                  <Button variant="outlined" color="primary" onClick={() => handleClaim(item.itemName, item.description, item.contact)}>
                        Claim
                  </Button>
                </CardActions>
